...
class RobotNode(Node):
    ...
    def __init__(self):
        ...
        # sub
        self.create_subscription(Pose2D, self.__POSE_TOPIC, self.pose_callback, 10)
        self.create_subscription(PointCloud, self.__TARGETS_TOPIC, self.targets_callback, 10)
    ...
    def targets_callback(self, msg):
        ...
        self.get_logger().info(f'Received {len(self.segments)} segments')
